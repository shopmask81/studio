                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="grid sm:grid-cols-3 gap-4">
                                <FormField control={form.control} name="city" render={({ field }) => (
                                    <FormItem><FormLabel>City</FormLabel><FormControl><Input placeholder="Venice" {...field} /></FormControl><FormMessage /></FormItem>
                                )} />
                                <FormField control={form.control} name="postalCode" render={({ field }) => (
                                    <FormItem><FormLabel>Postal Code</FormLabel><FormControl><Input placeholder="90210" {...field} /></FormControl><FormMessage /></FormItem>
                                )} />
                                ...
                                <FormItem className="space-y-3">
                                    ...
                                    >
                                        <FormItem className="flex items-center space-x-3 space-y-0 rounded-md border p-4 transition-colors data-[state=checked]:border-primary">
                                            ...
                                            <FormLabel className="font-normal flex-grow">Credit / Debit Card</FormLabel>
                                        ...
                                        <FormItem className="flex items-center space-x-3 space-y-0 rounded-md border p-4 data-[state=checked]:border-primary">
                                            ...
                                            <FormLabel className="font-normal flex-grow">PayPal</FormLabel>
                                         ...
                                         <FormItem className="flex items-center space-x-3 space-y-0 rounded-md border p-4 data-[state=checked]:border-primary">
                                            ...
                                            <FormLabel className="font-normal flex-grow">Cash on Delivery</FormLabel>
                                        </FormItem>
                                    </RadioGroup>
                                    </FormControl>
                                    <FormMessage />
